...
var getMostRecentFileIds = function getMostRecentFileIds(languageId) {
  var options = {
    method: 'POST',
  ...
  return (0, _requestPromise2.default)(options).then(function (body) {
    return body.reduce(function (obj, _ref) {
...
// const updateFileIds = (files) => {
//   const filenames = Object.keys(files);
//   filenames.forEach((file) => {
//     const { fileId, updated } = files[file];
//     const filepath = `${sourceFiles}/${file}`;
//     // need to update target data how do i get lang code
//   })
// }

var updateToRecentTargetData = function updateToRecentTargetData() {
  return getTargetLangs().then(function (languages) {
    languages.forEach(function (_ref3) {
      var lg = _ref3.lg,
          langId = _ref3.langId;

      getMostRecentFileIds(langId).then(function (files) {
        var filenames = (0, _keys2.default)(files);
        filenames.forEach(function (file) {
          var _files$file = files[file],
              fileId = _files$file.fileId,
              updated = _files$file.updated;
...
var updateSourceData = function updateSourceData(file, fileId, filepath) {
...
var getAllQordobaTimestamps = function getAllQordobaTimestamps(languages, files) {
  var timestamps = [];
  languages.forEach(function (_ref9) {
    var lg = _ref9.lg,
        langId = _ref9.langId;
...
var syncTargetFiles = function syncTargetFiles() {
  ...
  .then(function (qTimestamps) {
    ...
    languages.forEach(function (_ref10) {
      var lg = _ref10.lg,
          langId = _ref10.langId;
